...
function App() {
  ...
  return (
    <main className="page appShell">
      ...
      {activePage === 'control' && <ControlWorkPage api={api} program={program} canEdit={canEditWorkspace} setError={setError} setSuccess={setSuccess} loadHistory={loadHistory} goToRpd={() => setActivePage('rpd')} />}
      {activePage === 'fos' && <FosPage api={api} program={program} user={user} setError={setError} setSuccess={setSuccess} goToRpd={() => setActivePage('rpd')} />}
      {activePage === 'administration' && <AdministrationPage user={user} api={api} program={program} programsHistory={programsHistory} generationsHistory={generationsHistory} loadHistory={loadHistory} isHistoryLoading={isHistoryLoading} openProgram={openProgram} openProgramForDemo={openProgramForDemo} adminUsers={adminUsers} updateAdminUserRole={updateAdminUserRole} toggleAdminUser={toggleAdminUser} showAdvancedUi={showAdvancedUi} toggleAdvancedUi={() => setShowAdvancedUi((value) => !value)} setError={setError} setSuccess={setSuccess} />}
    </main>
  );
}
