...
DOMAIN_PROFILES = {
    "software_engineering": {
        "label": "Технологии разработки программного обеспечения",
        "keywords": ["технологии разработки программного обеспечения", "разработка программного обеспечения", "обеспечение качества программных средств", "devops", "жизненный цикл", "проектирование по", "тестирование программного обеспечения"],
        "topics": [
            ...
            "Сопровождение, развитие и документирование программных систем",
        ],
        "outcomes": [
            "Знать этапы жизненного цикла программного обеспечения и основные технологии разработки.",
            "Уметь анализировать требования, выбирать технологический подход и проектировать программное решение.",
            "Владеть навыками оценки качества, тестирования и документирования программного продукта.",
        ],
        "task_focus": "жизненный цикл ПО, требования, проектирование, тестирование, качество, DevOps",
    },
    "history_russia": {
